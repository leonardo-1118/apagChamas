    ...
    return (
        <Container>
            ...
            <div className="social-contacts">
                ...
                <a href="https://api.whatsapp.com/send?phone=5511947372825&text=Ol%C3%A1!%20Gostaria%20de%20mais%20informa%C3%A7%C3%B5es%20sobre%20os%20servicos%20da%20Apag%20Chamas" target="blank">
                    <div className="box">
                        <FaWhatsapp />
                    </div>
                    <p>WhatsApp</p>
                ...
                <a href="tel:5511947372825" target="blank">
                    <div className="box">
                        <BsTelephoneForward />
                    </div>
                    <p>Telefone</p>
